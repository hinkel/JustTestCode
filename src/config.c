...
//  cfg.mag_dec                   = 0;          // For example, -6deg 37min, = -637 Japan, format is [sign]dddmm (degreesminutes) default is zero.
    ...
    cfg.acc_lpfhz                 = 4.0f;       // Acc LPF in Hz for angle/horizon 0.536f resembles somehow the orig mwii factor
    cfg.acc_altlpfhz              = 18.0f;      // LPF in HZ just for althold
    cfg.acc_gpslpfhz              = 13.0f;      // LPF in HZ just for GPS ins stuff
    cfg.looptime                  = 3000;
    ...
    cfg.gy_cmpfm                  = 4000;       // (10-2000) 200 default for 10Hz. Now higher. Gyro/Magnetometer Complement.
    cfg.gy_smrll                  = 0;
    cfg.gy_smptc                  = 0;
...
//  cfg.nav_controls_heading      = 1;          // 1 = Nav controls YAW during WP ONLY
    ...
    //
    // Maxboticx I2CXL (MB1202, MB1212, MB1222, MB1232, MB1242)
